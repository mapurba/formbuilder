(function(){
	...
	angular
		.module('app', ['ngMaterial', 'ngAnimate',"ui.bootstrap", "ui.select", "formio", "ngFormBuilder", "angular-jsoneditor"])
		.controller('TodoController',['$scope', 'logger',"$rootScope",'formioComponents','$timeout', TodoController]);

	function TodoController($scope, logger, $rootScope,
		formioComponents,
		$timeout)  {
		$rootScope.displays = [{
			name: 'form',
